...
>
    ...
    <nav class="flex-1 space-y-1 overflow-y-auto px-3 py-4" @click="mobileNavOpen = false">
        ...
        <x-sidebar-link :href="route('rules.index')" :active="request()->routeIs('rules.*')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
        ...
        @if (Auth::user()->business?->hasSupportAccess() && Auth::user()->hasPermission(\App\Support\TeamPermissions::SUPPORT))
        ...
        @if (Auth::user()->canManageBusinessSettings())
            ...
            <x-sidebar-link :href="route('onboarding.create')" :active="request()->routeIs('onboarding.create')">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
    ...
    <div class="border-t border-gray-200 p-3 dark:border-gray-700">
        <button
            ...
            class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-900 transition duration-150 ease-in-out dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-100"
        >
