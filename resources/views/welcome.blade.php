...
@section('content')
    ...
    <div class="bg-cream">
        <div class="max-w-6xl px-6 mx-auto flex flex-col lg:flex-row items-stretch">
            <div class="flex flex-col w-full lg:w-5/12 justify-center lg:pt-6 items-start text-center lg:text-left mb-5 md:mb-0">
                <h1 data-aos="fade-right" data-aos-once="true" class="my-4 text-5xl sm:text-6xl font-bold leading-tight text-navy">
                    <span class="text-green-600">Build Your Own</span> Quote Calculator
                </h1>
                <p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="leading-normal text-xl mb-8 text-gray-600">Create custom quote calculators for your business. Set your products, options, pricing and rules, then use them internally or give your customers a simple way to get a quote online.</p>
    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8 text-gray-700 overflow-x-hidden">

        <!-- Intro video -->
        <section class="bg-white overflow-hidden mt-4">
            <div class="flex flex-col lg:flex-row items-center py-16 lg:py-24">
                <div class="w-full lg:w-1/2 text-center lg:text-left" data-aos="fade-right" data-aos-once="true">
                    ...
                    <h2 class="text-4xl sm:text-5xl font-bold leading-tight text-gray-900">
                        Create accurate <span class="text-green-600">quotes faster.</span>
                    </h2>
                    <p class="mt-6 text-lg leading-relaxed text-gray-600 max-w-xl mx-auto lg:mx-0">
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                        ...
                        <a href="#how-it-works" class="w-full sm:w-auto inline-flex items-center justify-center px-7 py-4 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition duration-300">
                            See How It Works
                        </a>
                    </div>
        ...
        <div data-aos="fade-up" data-aos-once="true" class="max-w-2xl mx-auto text-center mt-16">
            <h2 class="font-bold text-navy my-3 text-4xl sm:text-5xl">Manual quoting <span class="text-green-600">is costing you business</span></h2>
            <p class="leading-relaxed text-gray-500">Slow estimates, spreadsheet errors, and hidden pricing all push potential customers toward a competitor who answers faster.</p>
        </div>

        <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
            <div data-aos="fade-up" data-aos-once="true" class="bg-white shadow-xl p-6 text-center rounded-xl">
                ...
                <h3 class="font-medium text-xl mb-3 lg:px-6 text-navy">Slow Quotes Lose Sales</h3>
                <p class="px-4 text-gray-500">Buyers want instant answers. Waiting 24 to 48 hours for a manual estimate gives leads time to buy from your competitors.</p>
            </div>
            <div data-aos="fade-up" data-aos-once="true" data-aos-delay="150" class="bg-white shadow-xl p-6 text-center rounded-xl">
                ...
                <h3 class="font-medium text-xl mb-3 lg:px-6 text-navy">Spreadsheets Break</h3>
                <p class="px-4 text-gray-500">One incorrect formula, missing row, or outdated rate sheet ruins your profit margins and leads to costly errors.</p>
            </div>
            <div data-aos="fade-up" data-aos-once="true" data-aos-delay="300" class="bg-white shadow-xl p-6 text-center rounded-xl">
                ...
                <h3 class="font-medium text-xl mb-3 lg:px-6 text-navy lg:h-14 pt-3">Hidden Pricing Kills Conversions</h3>
                <p class="px-4 text-gray-500">Modern buyers skip businesses that require them to fill out long contact forms or book sales calls just to get a baseline price.</p>
            </div>
        </div>
        ...
        <div id="how-it-works" class="md:flex mt-32 md:space-x-10 items-start scroll-mt-24">
            ...
            <div data-aos="fade-left" data-aos-once="true" class="md:w-5/12 mt-20 md:mt-0 text-gray-500">
                <div class="inline-flex items-center px-4 py-2 mb-6 rounded-full bg-green-50 text-green-700 text-sm font-semibold">
                    <span class="w-2 h-2 mr-2 rounded-full bg-green-500"></span>
                    See How it Works
                </div>
                <h2 class="text-3xl sm:text-4xl font-semibold text-navy"><span class="text-green-600">From price list to</span> live calculator in 4 simple steps</h2>

                <div class="flex items-start space-x-5 my-5">
                    <div class="flex-shrink-0 bg-white shadow-lg rounded-full w-11 h-11 flex items-center justify-center font-bold text-green-600">1</div>
                    <p class="pt-2">Add Your Products: Enter your core products, services, materials, or billable options.</p>
                </div>
                <div class="flex items-start space-x-5 my-5">
                    <div class="flex-shrink-0 bg-white shadow-lg rounded-full w-11 h-11 flex items-center justify-center font-bold text-green-600">2</div>
                    <p class="pt-2">Set Prices &amp; Rules: Define base rates, conditional logic, variable quantities, and percentage add-ons.</p>
                </div>
                <div class="flex items-start space-x-5 my-5">
                    <div class="flex-shrink-0 bg-white shadow-lg rounded-full w-11 h-11 flex items-center justify-center font-bold text-green-600">3</div>
                    <p class="pt-2">Test &amp; Preview: Test your custom calculator in real-time to ensure every rule calculates perfectly.</p>
                </div>
                <div class="flex items-start space-x-5 my-5">
                    <div class="flex-shrink-0 bg-white shadow-lg rounded-full w-11 h-11 flex items-center justify-center font-bold text-green-600">4</div>
        ...
        <!-- DIY vs DFY -->
        <section class="bg-gray-50 rounded-2xl py-16 lg:py-24 mt-24">
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-gray-900 text-center mb-14">
                    Two ways to <span class="text-green-600">get started.</span>
                </h2>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                    <div data-aos="fade-up" data-aos-once="true" class="group relative flex flex-col h-full bg-white rounded-2xl border border-gray-200 p-8 overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-xl hover:border-green-200">
                        ...
                        <div class="w-12 h-12 rounded-xl bg-green-100 flex items-center justify-center text-green-600 mb-6 transition-transform duration-300 group-hover:scale-110">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                        </div>
                        <div class="inline-flex items-center px-4 py-1.5 mb-4 rounded-full bg-green-50 text-green-700 text-xs font-bold tracking-wide w-fit">DIY</div>
                        <h3 class="text-3xl font-bold text-gray-900 mb-3">Build it yourself</h3>
                        <p class="text-gray-600 leading-relaxed flex-1">You know your business best. Set up your products, pricing and rules yourself, make changes whenever you need, and keep complete control of your quote system.</p>
                        <a href="{{ route('pricing') }}" class="inline-flex items-center mt-6 font-semibold text-green-600">
                            Start building
                    ...
                    <div data-aos="fade-up" data-aos-once="true" data-aos-delay="150" class="group relative flex flex-col h-full bg-white rounded-2xl border border-gray-200 p-8 overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-xl hover:border-green-200">
                        <div class="absolute top-0 left-0 w-full h-1.5 bg-green-600 scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300 ease-out"></div>
                        <div class="w-12 h-12 rounded-xl bg-green-100 flex items-center justify-center text-green-600 mb-6 transition-transform duration-300 group-hover:scale-110">
                        ...
                        <div class="inline-flex items-center px-4 py-1.5 mb-4 rounded-full bg-green-50 text-green-700 text-xs font-bold tracking-wide w-fit">DFY</div>
                        <h3 class="text-3xl font-bold text-gray-900 mb-3">We build it for you</h3>
                        <p class="text-gray-600 leading-relaxed flex-1">Tell us what you sell and how you price it. Our team will build and configure your quote calculator for you, so you can start using it without spending time learning or setting up the system.</p>
                        <a href="{{ route('contact') }}" class="inline-flex items-center mt-6 font-semibold text-green-600">
                            Get a setup quote
                            <svg class="w-4 h-4 ml-1.5 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                        </a>
                    </div>
        ...
        <div class="flex flex-col md:flex-row items-center md:space-x-10 mt-20">
            <div data-aos="fade-right" data-aos-once="true" class="md:w-1/2">
                <h2 class="text-navy font-semibold text-4xl sm:text-5xl"><span class="text-green-600">A calculator</span> your customers can use — anytime</h2>
                <p class="text-gray-500 my-4 lg:pr-10">Put your calculator on your website and let customers select what they need, see estimated pricing and submit their quote request without having to call or email your team.</p>
            </div>
        ...
        <div class="mt-20">
            <div data-aos="fade-up" data-aos-once="true" class="max-w-3xl mx-auto text-center">
                <div class="inline-flex items-center px-4 py-2 mb-6 rounded-full bg-green-50 text-green-700 text-sm font-semibold">Internal business tool</div>
                <h2 class="font-semibold text-navy text-4xl sm:text-5xl">One place to manage, <span class="text-green-600">your quoting</span>, process</h2>
                <p class="text-gray-500 my-5">Give your team one place to manage products, pricing, options and quotes. Keep everyone working from the same information.</p>
            </div>
