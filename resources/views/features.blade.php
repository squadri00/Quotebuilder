...
@section('content')
        ...
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center gap-14">
                ...
                <div class="w-full lg:w-1/2" data-aos="fade-right" data-aos-once="true">
                    <div class="inline-flex items-center px-4 py-2 mb-6 rounded-full bg-green-100 text-green-700 text-sm font-semibold">
    ...
    <section class="bg-gray-50 py-16 lg:py-24">
        <div class="max-w-6xl mx-auto px-6 lg:px-8 text-center">
            ...
            <h2 class="text-3xl sm:text-4xl font-bold text-gray-900">Powerful features, zero complexity</h2>
            <p class="mt-4 text-gray-500 max-w-2xl mx-auto">Every tool you need to build, price, and send quotes — designed for business owners, not developers. Explore what {{ config('app.name', 'Quotaire') }} can do for you.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-14 text-left">
                ...
                @foreach ($features as $feature)
                    <div class="bg-white rounded-2xl border border-gray-100 p-7" data-aos="fade-up" data-aos-once="true">
                        <div class="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-green-600 mb-5">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">{{ $feature['body'] }}</p>
                    </div>
                @endforeach

            </div>

            <div class="mt-6 bg-white rounded-2xl border border-gray-100 p-7 text-left max-w-2xl mx-auto md:max-w-none md:flex md:items-start md:gap-6" data-aos="fade-up" data-aos-once="true">
                <div class="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-green-600 mb-5 md:mb-0 flex-shrink-0">
                ...
                <div>
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Industry templates</h3>
                    <p class="text-gray-600 text-sm leading-relaxed max-w-2xl">Get started fast with pre-built templates for printing, HVAC, cabinets, manufacturing, remodeling, and furniture — fully editable to match your exact pricing. <a href="{{ route('demo') }}" class="text-green-600 font-semibold hover:underline">Try a live one &rarr;</a></p>
                </div>
            </div>
    ...
    <section class="bg-white py-16 lg:py-24">
        <div class="max-w-3xl mx-auto px-6 text-center">
            <h2 class="text-3xl sm:text-4xl font-bold text-gray-900">See every feature in action</h2>
