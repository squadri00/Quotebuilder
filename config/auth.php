...
return [
    ...
    */
    ...
    'guards' => [
        ...
        // Platform-level super admins — a completely separate login from
        // business accounts. Being authenticated on one guard says nothing
        // about the other, which is what keeps /superadmin/* routes and
        // business admin routes from ever leaking into each other.
        'admin' => [
            'driver' => 'session',
            'provider' => 'admins',
        ],
